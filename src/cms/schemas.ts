  ...
  sections: [
    ...
    },
    {
      ...
      defaults: {
        ...
        items: [
          { name: "Pau", role: "Fundador & Estrategia", emoji: "🎲", photo: "", bio: "Responsable de buscar colaboraciones y crear nuevos eventos. Toma las decisiones estratégicas. De día abogado de startups; de noche, una buena peli con pizza margherita.", favoriteGame: "King of Tokyo", color: "Azul", luckyNumber: "7" },
          { name: "Pol", role: "Arquitecto de juegos", emoji: "🏗️", photo: "", bio: "Mantiene el orden en la colección de juegos de KLEFF. Se describe como arquitecto de juegos, colaborando con autores y editores para perfeccionar reglas.", favoriteGame: "Splendor", color: "Azul", luckyNumber: "7" },
          { name: "Beatriz", role: "Eventos & retos", emoji: "🎯", photo: "", bio: "Apoya en la organización de eventos. Maestra de educación infantil con corazón de jugona. Le encanta diseñar retos, enseñar jugando y vivir aventuras.", favoriteGame: "Stone Age", color: "Me gusta variar", luckyNumber: "2" },
          { name: "Jordi", role: "Equipo KLEFF", emoji: "🎮", photo: "", bio: "Próximamente. Estamos preparando su ficha completa.", favoriteGame: "—", color: "—", luckyNumber: "—" },
          { name: "Karen", role: "Equipo KLEFF", emoji: "✨", photo: "", bio: "Próximamente. Estamos preparando su ficha completa.", favoriteGame: "—", color: "—", luckyNumber: "—" },
          { name: "Leiro", role: "Equipo KLEFF", emoji: "🃏", photo: "", bio: "Próximamente. Estamos preparando su ficha completa.", favoriteGame: "—", color: "—", luckyNumber: "—" },
          { name: "Eric", role: "Equipo KLEFF", emoji: "🎲", photo: "", bio: "Próximamente. Estamos preparando su ficha completa.", favoriteGame: "—", color: "—", luckyNumber: "—" },
