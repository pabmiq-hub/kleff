...
import { Table, TableBody, TableCell, TableHead, TableHeader, TableRow } from "@/konektum/ui/table";
import { Checkbox } from "@/konektum/ui/checkbox";
import { Card, CardContent, CardHeader, CardTitle, CardDescription } from "@/konektum/ui/card";
import { AlertDialog, AlertDialogAction, AlertDialogCancel, AlertDialogContent, AlertDialogDescription, AlertDialogFooter, AlertDialogHeader, AlertDialogTitle, AlertDialogTrigger } from "@/konektum/ui/alert-dialog";
import { Search, Trash2, Eye, Merge, Send, Users, AlertTriangle, RefreshCw, Filter, X } from "lucide-react";
import { useCRM, type CRMUser, type DuplicateGroup } from "@/konektum/hooks/useCRM";
