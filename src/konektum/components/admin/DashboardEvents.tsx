...
import { Tabs, TabsList, TabsTrigger } from "@/konektum/ui/tabs";
...
import { Tooltip, TooltipContent, TooltipTrigger, TooltipProvider } from "@/konektum/ui/tooltip";
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
            ...
            <TooltipProvider>
              <Tooltip>
                <TooltipTrigger asChild>
                  <Link to="/admin/konektum/eventos/nuevo?testMode=1">
          ...
          <Link to="/admin/konektum/eventos/nuevo">
            <Button variant="hero">
        ...
        <Card className="text-center py-12">
          <CardContent>
            ...
            <h3 className="font-display text-xl font-semibold mb-2">
              {tab === "past" ? "Sin eventos pasados" : "Sin eventos próximos"}
            </h3>
            {tab === "upcoming" && (
              <>
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                  ...
                  <div className="flex items-center gap-6">
                    ...
                    <div className="flex gap-2">
                      <Link to={`/admin/konektum/eventos/${event.id}`}>
