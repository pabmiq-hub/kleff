...
import { Dialog, DialogContent, DialogHeader, DialogTitle } from "@/konektum/ui/dialog";
...
import type { CRMUser } from "@/konektum/hooks/useCRM";
...
export function RemarketingCampaignModal({ open, onOpenChange, selectedUsers, allUsers, events }: RemarketingCampaignModalProps) {
  ...
  const [sendMode, setSendMode] = useState<'skip_registered' | 'skip_both' | 'send_all'>('skip_both');
