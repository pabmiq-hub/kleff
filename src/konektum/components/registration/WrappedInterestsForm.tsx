...
import type { WrappedQuestion, WrappedAnswers } from "@/konektum/lib/wrappedQuestions";
import { FieldError } from "@/konektum/ui/field-error";
import { fieldErrorMessage } from "@/konektum/lib/formErrors";
...
const WrappedInterestsForm = ({ questions, lang, values, onChange, errors = [] }: Props) => {
