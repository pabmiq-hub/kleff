  ...
  errorComponent: () => (
    <SiteLayout>
      <div className="max-w-2xl mx-auto px-6 py-24 text-center">
        <h1 className="font-display text-3xl mb-3">No se pudo cargar la inscripción</h1>
        <p className="text-muted-foreground">Vuelve a intentarlo en unos minutos.</p>
      </div>
    </SiteLayout>
  ),
  notFoundComponent: () => (
    <SiteLayout>
      <div className="max-w-2xl mx-auto px-6 py-24 text-center">
        ...
        <p className="text-muted-foreground">La inscripción que buscas no está disponible.</p>
      </div>
    </SiteLayout>
  ),
  ...
  return (
    <SiteLayout>
      ...
      <div className="max-w-2xl mx-auto px-6 py-12">
        <h1 className="font-display text-3xl md:text-4xl mb-3 text-foreground">{form.title_es}</h1>
        {form.description_es && <p className="text-muted-foreground whitespace-pre-line mb-6">{form.description_es}</p>}

        {form.external_mode === "iframe" && form.external_url ? (
          <iframe src={form.external_url} className="w-full h-[800px] rounded-lg border border-border bg-white" title={form.title_es} />
        ) : done ? (
          <div className="rounded-lg border border-coral/30 bg-coral/5 p-6 text-center">
            ...
            <p className="text-muted-foreground whitespace-pre-line">{form.confirmation_message_es ?? "Hemos recibido tu inscripción. Te contactaremos por email."}</p>
