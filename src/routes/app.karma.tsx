        ...
        <TabsContent value="ranking" className="space-y-4 pt-4">
          ...
          {ranking.length > 0 ? (
            <div className="rounded-2xl border-2 border-coral/40 bg-coral/10 p-5 flex items-center gap-4">
              {ranking[0].avatarUrl ? (
                <img width={56} height={56} loading="lazy" decoding="async" src={ranking[0].avatarUrl} alt="" className="h-14 w-14 rounded-full object-cover" />
              ) : (
            ...
            {ranking.length === 0 ? (
              ...
              ranking.map((r, i) => (
                <div key={r.userId} className="p-3 flex items-center gap-3">
                  ...
                  {r.avatarUrl ? (
                    <img width={32} height={32} loading="lazy" decoding="async" src={r.avatarUrl} alt="" className="h-8 w-8 rounded-full object-cover" />
                  ) : (
