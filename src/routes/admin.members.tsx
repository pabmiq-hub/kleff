                ...
                <tr key={m.id} className="border-t border-ink/10 hover:bg-ink/5">
                  ...
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-3">
                      {m.avatar_url ? (
                        <img width={36} height={36} loading="lazy" decoding="async" src={m.avatar_url} alt="" className="h-9 w-9 rounded-full object-cover border border-ink/20" />
                      ) : (
          ...
          {filtered.map((m) => (
            ...
            >
              <div className="flex items-center gap-3 mb-3">
                {m.avatar_url ? (
                  <img width={56} height={56} loading="lazy" decoding="async" src={m.avatar_url} alt="" className="h-14 w-14 rounded-full object-cover border-2 border-coral" />
                ) : (
            ...
            <>
              ...
              <div className="mt-6 space-y-6">
                <div className="flex items-center gap-4">
                  {selected.avatar_url ? (
                    <img width={80} height={80} loading="lazy" decoding="async" src={selected.avatar_url} alt="" className="h-20 w-20 rounded-full object-cover border-2 border-coral" />
                  ) : (
